        ...
        <div className={styles.infoCard}>
          ...
          <div className={styles.dataGrid}>
            ...
            <div className={styles.dataRow}>
              ...
              <span>{product.regulatory?.riskCategory || 'Low'}</span>
            </div>
            <div className={styles.dataRow}>
            ...
            <div className={styles.dataRow}>
              ...
              <div className={styles.tagGroup}>
                {product.regulatory?.market?.map((m, i) => (
                  <span key={i} className={styles.marketTag}>{m}</span>
                )) || 'N/A'}
              </div>
            </div>
          </div>
  ...
  const fetchAllProducts = async () => {
    ...
    try {
      ...
      for (const org of orgs) {
        ...
        } catch { /* no products for this org */ }
      }
