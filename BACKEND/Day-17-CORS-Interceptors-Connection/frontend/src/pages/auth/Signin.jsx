        ...
        <div className="si-right">
          <div className="si-card">
            ...
            <p className="si-form-desc">
              New to the platform? <a href="/signup">Request access →</a>
            </p>
            ...
            <div className="si-fields">
              ...
              <div className="si-field">
                ...
                <div className="si-wrap">
                  ...
                  <input className="si-input" type="email" placeholder="your@organisation.com"
              ...
              <div className="si-field">
                ...
                <div className="si-wrap">
                  ...
                  <input className="si-input" type={showPwd ? "text" : "password"}
              ...
              <button className="si-btn" onClick={handleSubmit} disabled={loading}>
